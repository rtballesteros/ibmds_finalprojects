...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", 
            style={'text-align': 'center', 'color': '#503D56', 'font-size': 24}),#May include style for title
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unum_veh_sales = recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4  = dcc.Graph(
            figure=px.bar(unum_veh_sales,
                x='unemployment_rate',
                y='Automobile_Sales',
                color='Vehicle_Type',
                title="Average Automobile Sales By Vehicle Type During Recession",
...
# Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                ...
                values='Advertising_Expenditure',
                names='Vehicle_Type',
                title='Pie Chart for Total Advertisement Expenditure for Each Vehicle',
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(Y_chart1),html.Div(Y_chart2)],style={'display': 'grid'}),
                html.Div(className='chart-item', children=[html.Div(Y_chart3),html.Div(Y_chart4)],style={'display': 'grid'})
                ]
